...
public struct MacOSAlertChannel: AlertChannel {
    ...
    public init(notifyBinaryPath: String, logger: Logger) {
...
public struct AlertManager {
    ...
    public init(channels: [any AlertChannel], config: NotificationConfig, logger: Logger) {
    ...
    public func sendIfEnabled(scanComplete alert: Alert, hasIssues: Bool) {
        if hasIssues {
